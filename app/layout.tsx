...
export const metadata: Metadata = {
  ...
  description:
    "EDUS — the quality-assured online live learning platform. Join live online tuition, expert tutors, structured classes, parent updates, recordings, exams, and progress tracking. Explore Sri Lanka classes, India Grades 6 to 10, Maldives classes, and global one to one tuition.",
