      ...
      <div className="container-edge">
        ...
        <div className="mt-12 space-y-5">
          ...
          <div className="glass-strong rounded-[24px] p-7">
            <h3 className="font-display font-700 text-[14px] text-[#2563EB]">
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
              {SUBJECTS.map((s, i) => (
                <div key={s} className="rounded-2xl bg-white border border-[rgba(16,32,51,0.06)] p-4 text-center">
                  ...
                  <h4 className="font-display font-700 text-[15px] mt-1.5 text-[#102033]">
                    CBSE {s}
                  </h4>
                </div>
              ))}
          ...
          <div className="glass rounded-[24px] p-7">
            <h3 className="font-display font-700 text-[14px] text-[#8B5CF6]">
            ...
            <div className="mt-5 grid grid-cols-5 gap-3">
              {GRADES.map((g) => (
                ...
                >
                  <h4
                    className="font-display font-700 text-[36px] leading-none"
              ...
              {SCHEDULE.map((s) => (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-display font-600 text-[15px] tnum text-[#102033]">{s.time}</p>
                  </div>
                </div>
              ))}
            </div>
