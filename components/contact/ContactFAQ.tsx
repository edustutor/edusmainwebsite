...
import { FAQS } from "./ContactShared";
    ...
    <section className="relative py-12 md:py-16 overflow-hidden scroll-mt-24">
      ...
      <div className="container-edge">
        <m.div
          ...
          viewport={inView}
        >
          <p className="eyebrow"><span className="dot" />Contact FAQ</p>
          <h2 className="heading mt-4" style={{ fontSize: "var(--fs-display)" }}>
            Frequently asked{" "}
            <em>contact questions.</em>
          </h2>
          <p className="text-[#2B3950] text-[16px] mt-4 leading-relaxed">
            Everything parents and students ask before reaching out.
          </p>
        </m.div>
