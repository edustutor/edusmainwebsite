...
const STANDARDS = [
  ...
  "Cambridge IGCSE / O-Level syllabus understanding",
  "Clear English communication",
  "Student-friendly teaching style",
  "Past paper and exam preparation focus",
  "Regular feedback and academic accountability",
  "Respectful and professional class conduct",
];

export function MvTutors() {
  return (
      ...
      <div className="container-edge">
        ...
        >
          ...
          <div className="lg:col-span-6">
            <SectionHead
              align="left"
              eyebrow="Teacher Quality"
              title="Learn from tutors who care about"
              emphasis="results."
              body="EDUS tutors are selected for subject knowledge, clarity, communication, and student handling. We focus on confidence, discipline, and exam readiness - because every student learns differently."
            />
            ...
            >
              {STANDARDS.map((s) => (
                ...
                >
                  <span className="inline-flex w-5 h-5 rounded-full bg-[#06B6D4]/12 items-center justify-center shrink-0 mt-0.5">
                    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#06B6D4" strokeWidth="3" aria-hidden>
      ...
      <div className="relative rounded-[28px] bg-gradient-to-br from-[#E6FBFF] via-white to-[#EAFBF1] border border-white/80 shadow-[0_30px_80px_-30px_rgba(16,32,51,0.20)] p-6 md:p-7">
        ...
        <div className="flex items-center justify-between">
          ...
          <svg width="76" height="76" viewBox="0 0 36 36" className="shrink-0">
            ...
            <circle
              cx="18" cy="18" r="14"
              fill="none" stroke="#06B6D4" strokeWidth="4" strokeLinecap="round"
